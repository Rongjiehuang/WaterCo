...
class DEBLUR(object):
    ...
    def train(self):
        ...
        global_step = tf.Variable(initial_value=420, dtype=tf.int32, trainable=False)
        ...
        ckpt_name = model_name + '-' + str(420)
        checkpoint_dir = os.path.join(self.train_dir, 'checkpoints')
    ...
    def test(self, height, width, input_path, output_path):
        ...
        checkpoint_path = os.path.join(self.train_dir, 'checkpoints')
        self.load(sess, checkpoint_path, step=340)
