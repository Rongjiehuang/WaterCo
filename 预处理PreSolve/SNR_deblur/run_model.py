...
def parse_args():
    ...
    parser.add_argument('--batch_size', help='training batch size', type=int, default=10)
    parser.add_argument('--epoch', help='training epoch number', type=int, default=100)
...
def main(_):
    args = parse_args()
    args.phase = 'train'
    args.datalist = './datalist.txt'
    args.gpu_id='-1'
    args.input_path='F:/我的资源/data/predict/result/batch_1_new'
    args.output_path='F:/我的资源/data/predict/result2/batch_1_new'
